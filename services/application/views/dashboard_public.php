<div>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand" href="">SAKI SERVICE</a>

      <div class="textos"><a class="navbar-dark" href="#seccion1">Inicio</a></div>
      <div class="textos"><a class="navbar-dark" data-scroll href="#seccion3">Nosotros</a></div>
      <div class="textos"><a class="navbar-dark" data-scroll href="#seccion2">Cotizador</a></div>
      <div class="textos"><a class="navbar-dark" data-scroll href="#seccion5">Contacto</a></div>

      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link show-modal" data-toggle="modal" href="#modal2" onclick="vaciado_registro()">Registrarse</a>
          </li>
          <li class="nav-item">
  ...
  <section id="seccion1">
      <div class="container1">
        <video class="video" muted autoplay loop> <source src="<?= $url?>img/video2.mp4" type="video/mp4"></video>
      </div>
  </section>
            ...
            <div class="cotizador">
              ...
              <div class="tamañoCaja align-items-center text-center">
                ...
                <select name="tamañoCaja" id="comboTamañoCaja" class="comboTamañoCaja">
                  ...
                  <option value="Chica">Chica: (de 10cm a 60cm)</option>
                  <option value="Mediana">Mediana: (de 60cm a 150cm)</option>
                  <option value="Grande">Grande: (de 150cm a 300cm)</option>
                </select>
              </div>
      ...
      <div class="row">
        <div class="contactos col-lg-6 order-lg-1">
          ...
          <div class="direccion">
            ...
            <a class="textoDireccion">DEFINIR----------!!!<hr color="#ED05BF"/></a>
          </div>
        ...
        <div class="col-lg-6 order-lg-2">
            <form class="formulario" action="<?= $url ?>contactenos/contact_form" role="form" method="POST">
