            ...
            <form id="form-agregar-usuario" class="form-horizontal" role="form" action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="email" name="emailUsuario" id="emailUsuario" class="form-control" onblur="validarEmailAddUsuario()">
                                </div>
                        ...
                        <!--Comunas-->
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="lblcomuna"><span style="color: red;">*</span>Comuna</label>
                            <div class="col-sm-10">
                                <select name="selectComuna" id="selectComuna" class="form-control" required style="padding-right: 0px;">
                                ...
                                <div id="errorSelectComunaPersona" class="btn-danger erroBoxs" style="display: none">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="email" name="emailUsuarioModificar" id="emailUsuarioModificar" class="form-control" onblur="validarEmailAddUsuario()">
                                </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="lblcomuna"><span style="color: red;">*</span>Comuna</label>
                            <div class="col-sm-10">
                                <select name="selectComunaModificar" id="selectComunaModificar" class="form-control" required style="padding-right: 0px;">
                                    <option value="0">Seleccionar comuna</option>
                                    <?php
                                    if (isset($comunas)) :
                                        for ($i = 0; $i < count($comunas); $i++) :
                                ...
                                <div id="errorSelectComunaPersonaModificar" class="btn-danger erroBoxs" style="display: none">
                                    * Seleccione una comuna v&aacute;lida
                                </div>
                            </div>
                        </div>
