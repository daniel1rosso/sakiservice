...
<html lang="en">
    <head>
        ...
        <meta name="description" content="saki">
        <meta name="author" content="RebolaPramparoRosso">
        <meta name="keywords" content="saki">

        <link rel="shortcut icon" type="image/x-icon" href="<?= $url ?>img/5-1.ico">
        ...
        <script>
            //--- URL BASE ---//
            //LOCAL
            URL = '//190.122.143.202/sakiservice/';
        </script>
        ...
        <link href="<?= $url ?>assets/vendor/css-hamburgers/hamburgers.css" rel="stylesheet" media="all">
        ...
        <link href="<?= $url ?>assets/css/two-page-wonder.min.css" rel="stylesheet">
        ...
        <!--Sweet Alert-->
        <script type="text/javascript" src="<?= $url ?>assets/js/sweetalert2/swal2.js"></script>
