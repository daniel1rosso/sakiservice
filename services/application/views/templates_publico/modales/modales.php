          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="inputLogin col-sm-12" id="login" role="form" method="POST">
                <input type="text" placeholder="Usuario" name="username" id="username"  ><br>
                <input type="password" placeholder="Contraseña" name="password" id="password"><br>
                <input type="submit" id="ingreso_usuario"value="Iniciar Sesion">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content modalCotizador">
            ...
            <div class="modal-body align-items-center">
              <div class="divOrigen">
                <h5 class="text-center" id="origen_text"> Origen: {{origen}}</h5>
              </div>
              <div class="divDestino align-items-center">
                <h5 class="text-center" id="destino_text">Destino: {{destino}}</h5>
              </div>
              <div class="divCantidad align-items-center">
                <h5 class="text-center" id="cantidad_text">Cantidad De Cajas: {{cantidad}}</h5>
              </div>
              <div class="divTamaño align-items-center">
                <h5 class="text-center" id="tamaño_text">Tamaño De Cajas: {{tamaño}}</h5>
              </div>
              ...
              <p class="textoRecordatorio">Recuerde que realizando 5 o m&aacutes pedidos, no se cobraran los $1000,00 correspondientes al retiro del pedido</p>
